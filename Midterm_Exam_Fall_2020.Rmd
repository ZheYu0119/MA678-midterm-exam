...
1.Although I tried to use multilevel models, I am still not sure if this kind of data is suitable for multilevel.           
2.For there are three continuous outcome so it is a little bit difficult to draw the plots. If indeed that partners or roles will influence the score, I still not sure how to visualize it.     